...
// const inn = document.querySelector(".navbar__up-btn");
...
// const wbtn = document.querySelector(".header__hamburger--opened");
// const wxxbtn = document.querySelector(".header__hamburger--closed");

// btn.addEventListener("click", function () {
//     btn.classList.toggle("navbar__white-btn-black");
//     white.classList.toggle("black-body");
//     up.classList.toggle("navbar__in-btn--black");
//     inn.classList.toggle("navbar__up-btn--black");
